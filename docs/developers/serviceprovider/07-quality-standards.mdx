...
```markdown
[![Quality: Community](https://img.shields.io/badge/Quality-Community-3d9970?style=flat-square&labelColor=555)](https://open-control-plane.io/developers/serviceprovider/quality-criteria)
```

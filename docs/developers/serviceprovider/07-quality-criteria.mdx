...
This page defines the quality criteria a `ServiceProvider` should meet to be considered ready for use in different kinds of OpenControlPlane landscapes, from early-stage experiments to production environments with corporate compliance requirements.

The criteria exist for two audiences:

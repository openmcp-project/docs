...
This section covers all things related on how to control what your service provider is allowed to do on target clusters.
...
Next we need to create a `ClusterRequest` for our MCP cluster where we register our `TokenConfig`

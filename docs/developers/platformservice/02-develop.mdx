...
The important part is to choose whether you expose an external ([End User](../../users/00-getting-started.md) facing) API or an internal ([Platform Owner](../../users/00-getting-started.md) facing) API via the `watch` argument (see [deployment model](./design#deployment-model)).

...
Finally you need to implement your platform service specific logic inside `controller.go`. The template generates a basic `Reconcile` function for the e2e test to successfully create and delete an API object on the target cluster you choose when executing `template:generate-service`.

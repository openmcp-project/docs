...
<div className="reference-card">
  ...
  <a href="/reference/core/services/crossplane" className="reference-link">View CRD →</a>
</div>

<div className="reference-card">
  <h3>Landscaper</h3>
  <p>Declarative deployment orchestration service using Landscaper.</p>
  <a href="/reference/core/services/landscaper" className="reference-link">View CRD →</a>
</div>

<div className="reference-card">
  <h3>Velero</h3>
  <p>Backup and disaster recovery service using Velero.</p>
  <a href="/reference/core/services/velero" className="reference-link">View CRD →</a>
</div>

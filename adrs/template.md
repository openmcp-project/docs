...
status: {proposed | rejected | accepted | deprecated}<br>
...
informed: {list everyone who is kept up-to-date on progress; and with whom there is a one-way communication}<br>
<hr>
